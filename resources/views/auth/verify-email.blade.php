        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            <div>
                <a
                    ...
                    class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200"
                >
                    {{ __('Editar Perfil') }}</a>
                ...
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    ...
                    <button type="submit" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 ms-2">
                        {{ __('Cerrar sesión') }}
                    </button>
                </form>
            </div>
